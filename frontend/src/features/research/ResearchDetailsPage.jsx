          ...
          <header className="mb-10">
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              {research.external_url && (
                <a href={ensureExternalUrl(research.external_url)} target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-6 py-3 bg-navy dark:bg-white text-white dark:text-navy font-bold rounded-full hover:opacity-90 transition-opacity">
