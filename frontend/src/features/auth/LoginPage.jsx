...
import { BrainCircuit, Cpu, Sparkles, BookOpen, Code2, Rocket } from 'lucide-react';
...
export function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen pt-24 pb-12 flex items-center justify-center bg-[#F8F9FA] dark:bg-[#071225]">
      ...
      {/* Playful Floating Background Elements (Fixed to cover entire viewport) */}
      <div className="fixed inset-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        {/* Floating Icons scattered across the screen */}
      ...
      <div className="w-full max-w-md relative z-10 px-6">
        <div className="bg-white/90 dark:bg-surface-dark/95 backdrop-blur-xl border border-white/40 dark:border-white/10 rounded-[2.5rem] p-8 sm:p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)] dark:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)]">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="flex justify-start mt-2 px-2">
                <Link to="/forgot-password" className="text-[13px] font-bold text-gray-500 dark:text-gray-400 hover:text-navy dark:hover:text-amber transition-colors">
                  Forgot Password?
                </Link>
              </div>
            </div>
          ...
          <div className="mt-8 text-center text-sm font-medium text-gray-500 dark:text-gray-400">
            ...
            <Link to="/join" className="text-navy dark:text-amber hover:underline font-bold">
              Join Us
            </Link>
          </div>
